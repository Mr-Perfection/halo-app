...
export type AuthSignupMutationMutation = { __typename?: 'Mutation', signup: { __typename?: 'AuthPayload', token: string, user: { __typename?: 'User', firstName: string, lastName: string, email: string, role: UserRole } } };
