...
export type AuthSignupMutationMutation = { __typename?: 'Mutation', signup: { __typename?: 'AuthPayload', user: { __typename?: 'User', id: number, firstName: string, lastName: string, email: string, role: UserRole } } };
...
export type AuthLoginQueryQuery = { __typename?: 'Query', login: { __typename?: 'AuthPayload', user: { __typename?: 'User', id: number, firstName: string, lastName: string, email: string, role: UserRole } } };
