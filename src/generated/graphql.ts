...
export type PrivateRouteGetCurrentUserQuery = { __typename?: 'Query', getUser: { __typename?: 'User', id: number, firstName: string, lastName: string, email: string, role: UserRole, customer?: { __typename?: 'Customer', slug?: string | null } | null } };
